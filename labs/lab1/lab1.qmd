...
![Figure 6: Oscilloscope Trace Showing Blinking LED](images/oscilloscopeTrace.png){width="70%"}
...
![Figure 7: Hardware Execution Example 1 Showing Outputs to Switch Input 4b'1011](images/example1.jpg)

![Figure 7: Hardware Execution Example 1 Showing Outputs to Switch Input 4b'1001](images/example2.jpg)

## Conclusion
This lab took around 22 hours to complete mainly because I had to go through a lot of debugging processes to ensure my hardware works and connect to the board. In the end, it turned out to be the issue that I assigned hardware pin constraint to one of the SPI pins which is used to connect to the FPGA. The lab was amazing overall and I was able to brush off from my skill earned in E85.
