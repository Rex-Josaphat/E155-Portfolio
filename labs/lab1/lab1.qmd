...
![Figure 3: FPGA Experiment Wiring Setup](link)
...
Setting up the simulation was challenging due to different hurdles presented by Lattice Radiant, for example the tendency to sysnthesize the .tv file even though it's not Verilog. The testbench also required a "timeprecision specification" which was fixed by adding the code ``timescale 1ns/1ps` to the top of the testbench code. Running the simulation yielded the following waves:

![Figure 4: QuestaSim Screenshot Showing Simulation Outputs and Expected Outputs](link)

### Hardware Testing
The blinking LED could not be visualized using an automated testbench, Figure 5 below shows the oscilloscope trace indicating the LED is blinking at the desired 2.4Hz.

![Figure 5: Oscilloscope Trace Showing Blinking LED](link)
...
![Figure 6: Harware example 1](link)

![Figure 7: example 2](link)
