...
All components were collected and assembled on an extended breadboard following the schematic in @fig-Lab4Schematic. Using Segger Embedded Studio, the code was uploaded to the MCU to play the tunes, and ensure correct register and MCU timer declarations. The hardware responded properly as shown in the example video below:
